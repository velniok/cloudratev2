...
router.get('/suggestions/:userId', checkUser, getUser, UserControllers.getSuggestions)
router.get('/notifications/:userId', checkUser, getUser, UserControllers.getNotifications)
